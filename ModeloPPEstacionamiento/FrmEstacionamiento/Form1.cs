...
using EntidadesEstacionamiento; 
...
namespace FrmEstacionamiento
{
    public partial class FrmEstacionamiento : Form
    {
        ...
        private void FrmEstacionamiento_Load(object sender, EventArgs e)
        {
            ...
            this.estacionamiento = Estacionamiento.GetEstacionamiento("Ornela Ivana Curcio", 20);
            this.txtNombreEstaciomamiento.Text = this.estacionamiento.Nombre;
        }
        ...
        private void lstVehiculos_MouseDoubleClick(object sender, MouseEventArgs e)
        {
            ...
            {
                MessageBox.Show(this.estacionamiento.InformarSalida((Vehiculo)this.lstVehiculos.SelectedItem), 
